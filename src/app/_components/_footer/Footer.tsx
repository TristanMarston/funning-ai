...
const Footer = () => {
    return (
        <div className='relative w-full pb-6 flex flex-col items-center bg-gradient-to-br from-primary-50 to-primary-100'>
            ...
            <div className='max-w-[1280px] w-full px-5 flex flex-col items-center 2xl:flex-row 2xl:justify-between 2xl:items-start 2xl:px-10'>
                <section className='grid gap-2 place-items-center mt-20 2xl:mt-24 5xl:mt-32 8xl:mt-36 10xl:mt-42'>
                    ...
                    <h5 className='font-figtree font-bold text-xl text-shadow-xs text-center'>
                        Push your limits without <br className='hidden 2xl:block' /> pushing your luck.
                    </h5>
                </section>
